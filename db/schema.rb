...
ActiveRecord::Schema.define(:version => 20120816045034) do
  ...
  add_index "cce_reports", ["observable_id", "student_id", "batch_id", "exam_id", "observable_type"], :name => "cce_report_join_index", :limit => {"exam_id"=>nil, "batch_id"=>nil, "observable_id"=>nil, "student_id"=>nil, "observable_type"=>nil}
